...
namespace Pokedex
{
    public class PokedexWeakness : MonoBehaviour, IItemUpdater
    {
        ...
        private Type weakType1;
        private Type weakType2;

        public void UpdateItem(PokedexEntry entry)
        {
            weakType1 = Resources.Load<Type>($"Scriptable Objects/Types/{entry.pkType1}");
            weakType2 = Resources.Load<Type>($"Scriptable Objects/Types/{entry.pkType2}");
