...
namespace Pokedex
{
    public class PokedexEvolutionSplits : MonoBehaviour
    {
        ...
        [SerializeField] private List<PokedexEvolutions> esSlots = new List<PokedexEvolutions>();

        private EvoSplit esEntry;
